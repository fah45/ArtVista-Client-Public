            ...
            <div className="hero-content flex-col w-full p-8">
                ...
                <div className="card w-[100%]  shadow-2xl bg-white">
                    ...
                    <div className="flex justify-center gap-4 mb-6">
                        <Toaster />
                        <button className="btn rounded-full bg-orange-500" onClick={() => handleSocialLogin(googleSignIn)}><FaGoogle /></button>
                        <button className="btn rounded-full bg-orange-500" onClick={() => handleSocialLogin(gitHubSignIn)}><FaGithub /></button>
                    </div>
                </div>
            </div>
        </div>
